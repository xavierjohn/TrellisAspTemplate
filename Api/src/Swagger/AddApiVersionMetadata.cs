...
public class AddApiVersionMetadata : IOperationFilter
{
    ...
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        foreach (var parameter in operation.Parameters ?? (IList<IOpenApiParameter>)Array.Empty<IOpenApiParameter>())
        {
            ...
            // OpenAPI v2/v3 - Default and Required are now read-only
            // Swashbuckle handles these automatically in v10+
