  ...
  queries:
    - name: GetOrderById
      parameters:
        - orderId: OrderId
      returns: Order
      description: "Query to retrieve an order by its ID."
    ...
    - name: ListOrders
      parameters:
        ...
        - status: OrderStatus?
      returns: List<Order>
      description: "Query to list orders with optional filtering by customer and status."
  ...
  commands:
    - name: CreateOrder
      parameters:
        - customerId: CustomerId
      returns: Order
      description: "Command to create a new order for a customer."
    
    - name: SubmitOrder
      parameters:
        - orderId: OrderId
      returns: Order
      description: "Command to submit a draft order for processing."
